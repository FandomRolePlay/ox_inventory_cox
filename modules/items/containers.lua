...
setContainerProperties('ammocrate', {
	slots = 50,
	maxWeight = 35000,
    whitelist = {'weapon-parts','weapon-cleaning','weapon-parts_spec','snspistolset','snsmk2set','pistolset','pistolxm3set','pistol50set','revolverset','ceramicset','tecpistolset','machinepistolset','microsmgset','minismgset','smgset','sawnoffshotgun','dbshotgunset','pumpshotgunset','pumpshotgunmk2set','assaultrifleset','compactrifleset','assaultriflemk2set','tacticalrifleset','bullpuprifleset'}
})
